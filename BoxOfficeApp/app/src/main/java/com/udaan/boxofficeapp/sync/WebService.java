...
import com.udaan.boxofficeapp.model.AuthTokenResponse;
import com.udaan.boxofficeapp.model.BlogEntry;
...
import com.udaan.boxofficeapp.model.ClientTokenResponse;
import com.udaan.boxofficeapp.model.Commodity;
import com.udaan.boxofficeapp.model.Country;
import com.udaan.boxofficeapp.model.Movie;
import com.udaan.boxofficeapp.model.Order;
import com.udaan.boxofficeapp.model.Price;
import com.udaan.boxofficeapp.model.TransactionResponse;
import com.udaan.boxofficeapp.model.UserInfo;
...
public interface WebService {
    ...
    String PATH_CITY = "/api/booking/city/";
    String PATH_CINEMA = "/api/booking/cinema/{id}/";
    String PATH_MOVIE = "/api/booking/movie/{id}/";
    String PATH_CINEMA_NEARBY = "/api/booking/cinema_nearby/";
    String PATH_SEAT_AVAILABILTY="/api/booking/seat_available/";
    String  PATH_SEAT_LIST="/api/booking/seat/";
    String PATH_BOOKING_TICKET="/api/booking/book/";
    ...
    List<Movie> getMovies(
            @Path("id") String cinemaId
    );
    @GET(PATH_SEAT_AVAILABILTY)
    JsonObject getSeatAvailability(
            ...
            @Query("cinema_id") int cinemaId
    );
    @GET(PATH_SEAT_LIST)
    JsonObject getSeatList(
    ...
    @FormUrlEncoded
    @POST(PATH_BOOKING_TICKET)
    JsonObject doBooking(
            @Header(HEADER_AUTHORIZATION) String authToken,
    ...
    @GET(PATH_CINEMA_NEARBY)
    List<Cinema> getNearbyCinemas(
