...
import com.udaan.boxofficeapp.loader.ProductDetailLoader;
import com.udaan.boxofficeapp.model.ProductColor;
import com.udaan.boxofficeapp.provider.BoxOfficeContract;
import com.udaan.boxofficeapp.ui.widget.EmptyView;
import com.udaan.boxofficeapp.ui.widget.SynchronizedScrollView;
...
public class ProductDetailActivity extends BaseActivity implements SynchronizedScrollView.OnScrollListener,
    ...
    public Loader<Cursor> onCreateLoader(int id, Bundle args) {
        if (id == ProductQuery.LOADER_ID) {
            return new CursorLoader(this, BoxOfficeContract.ProductEntry.buildProductUri(mProductId),
...
//                    intent.putExtra(AddToCartActivity.EXTRA_COLOR_SIZE_DATA, mProductDetailsJson);
    ...
    interface ProductQuery {
        ...
        String[] PROJECTION = new String[]{
                ...
                BoxOfficeContract.ProductEntry.COLUMN_DESCRIPTION,
