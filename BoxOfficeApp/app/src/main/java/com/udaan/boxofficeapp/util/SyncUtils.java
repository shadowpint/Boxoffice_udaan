package com.udaan.boxofficeapp.util;
...
public class SyncUtils {
    ...
    //private static final String CONTENT_AUTHORITY = BoxOfficeContract.CONTENT_AUTHORITY;
    ...
    public static void onAccountCreated(Account newAccount, Context context) {
        ...
        // Inform the system that this account is eligible for auto sync when the network is up.
        ContentResolver.setSyncAutomatically(newAccount, BoxOfficeContract.CONTENT_AUTHORITY, true);
    ...
    private static void configurePeriodicSync(Account account, int syncInterval, int flexTime) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            ...
            SyncRequest request = new SyncRequest.Builder()
                    ...
                    .setSyncAdapter(account, BoxOfficeContract.CONTENT_AUTHORITY)
                    .setExtras(Bundle.EMPTY)
                    .build();
            ContentResolver.requestSync(request);
        } else {
            ContentResolver.addPeriodicSync(account, BoxOfficeContract.CONTENT_AUTHORITY,
    ...
    public static void syncImmediately(Context context) {
        ...
        ContentResolver.requestSync(activeAccount, BoxOfficeContract.CONTENT_AUTHORITY, extras);
    }
