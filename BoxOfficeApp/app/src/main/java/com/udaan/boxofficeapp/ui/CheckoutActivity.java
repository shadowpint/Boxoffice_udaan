...
import com.udaan.boxofficeapp.model.CreditCard;
import com.udaan.boxofficeapp.model.Price;
import com.udaan.boxofficeapp.ui.checkout.DateCheckoutFragment;
import com.udaan.boxofficeapp.ui.checkout.ReviewCheckoutFragment;
import com.udaan.boxofficeapp.ui.checkout.TicketCheckoutFragment;
import com.udaan.boxofficeapp.ui.widget.Stepper;
...
//                WindowManager.LayoutParams.FLAG_SECURE);
        ...
        mSelectedCinema = intent.getExtras().getParcelable("cinema");
        title = mSelectedCinema.getName();

        imageUrl = mSelectedCinema.getLeadImageUrl();
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        outState.putParcelable(STATE_SELECTED_EVENT, mSelectedCinema);
    ...
    protected void onRestoreInstanceState(Bundle savedInstanceState) {
        ...
        mSelectedCinema = savedInstanceState.getParcelable(STATE_SELECTED_EVENT);
    ...
    public Cinema getSelectedEvent() {
        return mSelectedCinema;
    }
    ...
    public void getToken() {
        ...
        intent.putExtra(OrderConfirmationActivity.EXTRA_EVENT, mSelectedCinema);
