...
import com.udaan.boxofficeapp.adapter.CityAdapter;
import com.udaan.boxofficeapp.adapter.HorizontalAdapter;
import com.udaan.boxofficeapp.loader.CityLoader;
import com.udaan.boxofficeapp.loader.NearbyEventLoader;
...
public class CityFragment extends BaseNavigationFragment implements LoaderManager.LoaderCallbacks<List<City>>, CityAdapter.CityAdapterListener, HorizontalAdapter.HorizontalAdapterListener, GoogleApiClient.ConnectionCallbacks,
    ...
    private LoaderManager.LoaderCallbacks<List<Cinema>> mNearbyEventCallbacks;
    /*enum UiState {
        LOADING,
        EMPTY,
        ERROR,
    ...
    private void procesarOnconectedLocation() {
        ...
        if (ActivityCompat.checkSelfPermission(getActivity(), Manifest.permission.ACCESS_FINE_LOCATION)
            ...
            if (mLastLocation != null) {
                ...
                mNearbyEventCallbacks = new LoaderManager.LoaderCallbacks<List<Cinema>>() {
                    @Override
                    ...
                    @Override
                    public void onLoadFinished(Loader<List<Cinema>> loader, List<Cinema> data) {
...
Log.e("city",city.getName());
    ...
    @Override
    public void onEventSelected(Cinema cinema) {

        Log.e("Cinema", cinema.getName());
