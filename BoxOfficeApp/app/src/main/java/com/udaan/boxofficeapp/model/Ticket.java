...
public class Ticket implements Parcelable {
    ...
    public Ticket(String priceName, String priceCost, String transactionId, String eventName, String eventTime, String eventImage, String eventGenre, List<String> seat, String eventVenue, String id) {
        this.priceName = priceName;
        this.priceCost = priceCost;
        this.transactionId = transactionId;
        this.eventName = eventName;
