...
import com.udaan.boxofficeapp.BuildConfig;
...
public class BoxOfficeDatabase extends SQLiteOpenHelper {

    private static final String LOG_TAG = BoxOfficeDatabase.class.getSimpleName();

    private static final String DATABASE_NAME = "BoxOffice_couture.db";
    ...
    public BoxOfficeDatabase(Context context) {
