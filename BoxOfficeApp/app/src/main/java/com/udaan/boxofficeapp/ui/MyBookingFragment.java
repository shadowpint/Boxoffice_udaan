...
import com.udaan.boxofficeapp.loader.BookingLoader;
    ...
    private void processOrderDetailsData(JsonArray data) {
        ...
        for(int i=0;i<data.size();i++){
            ticketList.add(new Ticket(data.get(i).getAsJsonObject().get("price").getAsJsonObject().get("name").getAsString(),
                    ...
                    data.get(i).getAsJsonObject().get("cinema").getAsJsonObject().get("name").getAsString(),
                    data.get(i).getAsJsonObject().get("cinema").getAsJsonObject().get("date").getAsString(),
                    data.get(i).getAsJsonObject().get("cinema").getAsJsonObject().get("leadImageUrl").getAsString(),
                    data.get(i).getAsJsonObject().get("cinema").getAsJsonObject().get("tags").getAsString(),
                   new ArrayList<>(Arrays.asList("B1", "B2", "B3")),



                    data.get(i).getAsJsonObject().get("cinema").getAsJsonObject().get("address").getAsString(),
...
//        JsonArray items = data.get("items").getAsJsonArray();
        ...
        Log.e("price", (data.get(0).getAsJsonObject().get("cinema").getAsJsonObject().get("date")).getAsString());
    }
