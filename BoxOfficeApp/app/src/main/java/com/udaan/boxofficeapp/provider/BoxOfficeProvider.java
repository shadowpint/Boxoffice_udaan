package com.udaan.boxofficeapp.provider;
...
import com.udaan.boxofficeapp.provider.BoxOfficeContract.OrderEntry;
import com.udaan.boxofficeapp.util.SelectionBuilder;

import java.util.List;

import static com.udaan.boxofficeapp.provider.BoxOfficeContract.AddressBookEntry;
import static com.udaan.boxofficeapp.provider.BoxOfficeContract.BrandEntry;
import static com.udaan.boxofficeapp.provider.BoxOfficeContract.CONTENT_AUTHORITY;
import static com.udaan.boxofficeapp.provider.BoxOfficeContract.CartEntry;
import static com.udaan.boxofficeapp.provider.BoxOfficeContract.CategoryEntry;
import static com.udaan.boxofficeapp.provider.BoxOfficeContract.PATH_ADDRESS_BOOK;
import static com.udaan.boxofficeapp.provider.BoxOfficeContract.PATH_BRAND;
import static com.udaan.boxofficeapp.provider.BoxOfficeContract.PATH_CART;
import static com.udaan.boxofficeapp.provider.BoxOfficeContract.PATH_CATEGORY;
import static com.udaan.boxofficeapp.provider.BoxOfficeContract.PATH_ORDER;
import static com.udaan.boxofficeapp.provider.BoxOfficeContract.PATH_PRODUCT;
import static com.udaan.boxofficeapp.provider.BoxOfficeContract.PATH_SUBCATEGORY;
import static com.udaan.boxofficeapp.provider.BoxOfficeContract.ProductEntry;
import static com.udaan.boxofficeapp.provider.BoxOfficeContract.SubcategoryEntry;
import static com.udaan.boxofficeapp.provider.BoxOfficeDatabase.Tables;

public class BoxOfficeProvider extends ContentProvider {
    private static final String TAG = BoxOfficeProvider.class.getSimpleName();

    // The URI Matcher used by this content provider.
    private static final UriMatcher sUriMatcher = buildUriMatcher();
    private BoxOfficeDatabase mOpenHelper;
    ...
    public boolean onCreate() {
        Log.d(TAG, "onCreate()");
        mOpenHelper = new BoxOfficeDatabase(getContext());
        return true;
    }
    ...
    private void notifyChange(@NonNull Uri uri) {
        if (!BoxOfficeContract.isCallerSyncAdapter(uri)) {
