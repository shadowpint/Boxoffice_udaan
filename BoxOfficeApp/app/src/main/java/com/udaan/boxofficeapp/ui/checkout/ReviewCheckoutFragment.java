package com.udaan.boxofficeapp.ui.checkout;
...
import com.udaan.boxofficeapp.ui.CheckoutActivity;
import com.udaan.boxofficeapp.ui.ShoppingCartActivity;
import com.udaan.boxofficeapp.ui.widget.CustomTypefaceSpan;
import com.udaan.boxofficeapp.util.FontUtils;
...
//            phone.setSpan(mMediumTypefaceSpan, 0, phone.toString().indexOf(':') + 1, 0);
    ...
    private void setEventInfo(Cinema cinema) {
        if (cinema != null) {
            mEventNameView.setText(cinema.getName());
            SimpleDateFormat formatter = new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ssZ", Locale.ENGLISH);
            //                Date d = formatter.parse(cinema.getDate().replaceAll("Z$", "+0000"));
//                DateFormat date = new SimpleDateFormat("MM/dd/yyyy");
//                DateFormat time = new SimpleDateFormat("hh:mm:ss a");
//                System.out.println("Date: " + date.format(d));
//                System.out.println("Time: " + time.format(d));
            mEventTimeView.setText("gsdfg");
